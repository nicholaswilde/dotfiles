...
if command_exists apt-get; then
  ...
  alias upgrate='sudo apt-get update && sudo apt-get -y upgrade && sudo apt-get -y autoremove && brew update && sudo snap refresh && sudo npm update -g && pip3 list --outdated --format=freeze | grep -v '^\-e' | cut -d = -f 1 | xargs -n1 pip3 install -U'
...
command_exists lynx && alias city="lynx -dump https://www.ip-adress.com/ip-address/ipv4/$(curl http://ipecho.net/plain; echo) | grep 'City' | awk '{print \$2,\$3,\$4,\$5,\$6}'"
